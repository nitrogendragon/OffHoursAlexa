...
const SKILL_NAME = 'off hours';
const CHOOSE_NUMBER_MESSAGE = "Here's the number I chose: ";
const FACT_CHECK_MESSAGE = "Here is the fact I found";
const HELP_MESSAGE = "You can say fact check, or, choose number... What can I help you with?";
...
app.post('/offhours', requestVerifier, function (req, res) {
